...
public partial class StoryPlatformContext : DbContext
{
    public StoryPlatformContext()
    {
    }

    public StoryPlatformContext(DbContextOptions<StoryPlatformContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server= TRUONG\\HIHITRUONGNE;uid=sa;password=123;database=story_platform;Encrypt=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__auth_tok__3213E83FF4F6FF09");

            entity.ToTable("auth_tokens");

            entity.HasIndex(e => e.RefreshToken, "uq_refresh_token").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__categori__3213E83F5056E5AD");

            entity.ToTable("categories");

            entity.HasIndex(e => e.Slug, "UQ__categori__32DD1E4C7E2AC6CC").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__chapters__3213E83F7A96FDA5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__stories__3213E83F1BB6BB61");

            entity.ToTable("stories");

            entity.HasIndex(e => e.Slug, "UQ__stories__32DD1E4CAD2A8137").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__users__3213E83F16A58FFA");

            entity.ToTable("users");

            entity.HasIndex(e => e.Email, "UQ__users__AB6E61643DC75D4C").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user_pro__B9BE370F15E1E349");

            entity.ToTable("user_profiles");

            entity.HasIndex(e => e.Nickname, "UQ__user_pro__5CF1C59B9CA87D85").IsUnique();
