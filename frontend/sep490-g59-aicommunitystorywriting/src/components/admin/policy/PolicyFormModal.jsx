                    ...
                    <div className="p-6 overflow-y-auto space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mb-2 leading-relaxed">
                                Mục chính: dòng <code className="rounded bg-slate-100 px-1">1. Tiêu đề</code> hoặc{' '}
                                <code className="rounded bg-slate-100 px-1">## Tiêu đề</code>. Mục phụ:{' '}
                                <code className="rounded bg-slate-100 px-1">2.1 Tiêu đề</code>. Dòng đầu (tiêu đề tài liệu) là đoạn văn
                                thường, không cần #. Danh sách chỉ dùng <code className="rounded bg-slate-100 px-1">- </code> hoặc{' '}
                                <code className="rounded bg-slate-100 px-1 mr-0">* </code>. Đoạn cách nhau bằng dòng trống.
                            </p>
                            <textarea
                                value={content}
                                onChange={(e) => setContent(e.target.value)}
                                rows={12}
                                placeholder={`Điều khoản và chính sách (tiêu đề tài liệu)\n\nĐoạn mở đầu...\n\n1. Mục một\n\n2.1 Mục phụ\n\nNội dung...\n\n- Gạch đầu dòng`}
                                className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 font-mono text-sm leading-relaxed"
                                required
                            />
                        </div>
