...
/// <summary>Request kiểm tra chương: lỗi chính tả, vi phạm chính sách, nội dung không phù hợp.</summary>
public class CheckChapterRequest
{
    /// <summary>Nội dung chương cần kiểm tra (bắt buộc).</summary>
    public string Content { get; set; } = null!;

    /// <summary>ID truyện (tùy chọn, dùng để lấy ngữ cảnh nếu cần).</summary>
    public Guid? StoryId { get; set; }

    /// <summary>Tiêu đề chương (tùy chọn).</summary>
