...
/// <summary>So sánh nội dung tác giả với <c>ai_output</c> cùng <c>story_id</c> và <c>chapter_index</c> = <c>order_index</c>; lấy điểm cao nhất. Không ghi DB — % lưu khi tạo/cập nhật chương qua <c>AiSimilarityPercent</c>.</summary>
